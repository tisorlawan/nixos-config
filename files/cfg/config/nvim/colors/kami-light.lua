...
local bg_main = transparent and 'NONE' or p.parchment
local bg_float = transparent and 'NONE' or p.ivory

local function hi(group, spec)
  vim.api.nvim_set_hl(0, group, spec)
end

hi('Normal', { fg = p.near_black, bg = bg_main })
hi('NormalNC', { fg = p.charcoal, bg = bg_main })
hi('NormalFloat', { fg = p.near_black, bg = bg_float })
hi('FloatBorder', { fg = p.border_warm, bg = bg_float })
hi('FloatTitle', { fg = p.brand, bg = bg_float })
hi('SignColumn', { fg = p.stone, bg = bg_main })
hi('EndOfBuffer', { fg = p.border_cream, bg = bg_main })
hi('FoldColumn', { fg = p.stone, bg = bg_main })
hi('Folded', { fg = p.olive, bg = p.warm_sand })
hi('ColorColumn', { bg = p.ivory })
...
hi('Cursor', { fg = p.parchment, bg = p.brand })
hi('lCursor', { fg = p.parchment, bg = p.brand })
hi('Visual', { bg = p.tag_deep })
hi('VisualNOS', { bg = p.tag })
hi('Search', { fg = p.near_black, bg = p.tag_deep })
hi('IncSearch', { fg = p.ivory, bg = p.brand })
hi('CurSearch', { fg = p.ivory, bg = p.brand })
hi('MatchParen', { fg = p.brand, underline = true })
hi('NonText', { fg = p.ring_warm })
hi('Whitespace', { fg = p.border_warm })
...
hi('StatusLine', { fg = p.charcoal, bg = p.warm_sand })
hi('StatusLineNC', { fg = p.stone, bg = p.border_cream })
hi('WinBar', { fg = p.charcoal, bg = bg_main })
hi('WinBarNC', { fg = p.stone, bg = bg_main })
hi('WinSeparator', { fg = p.border_warm, bg = bg_main })
hi('TabLine', { fg = p.olive, bg = p.warm_sand })
hi('TabLineFill', { fg = p.stone, bg = p.border_cream })
hi('TabLineSel', { fg = p.brand, bg = p.ivory, bold = true })
hi('Pmenu', { fg = p.charcoal, bg = bg_float })
hi('PmenuSel', { fg = p.ivory, bg = p.brand })
hi('PmenuSbar', { bg = p.border_cream })
hi('PmenuThumb', { bg = p.ring_warm })
hi('WildMenu', { fg = p.ivory, bg = p.brand })
...
hi('Identifier', { fg = p.near_black })
hi('Function', { fg = p.brand })
hi('Statement', { fg = p.dark_warm, bold = true })
hi('Conditional', { fg = p.dark_warm, bold = true })
hi('Repeat', { fg = p.dark_warm, bold = true })
hi('Label', { fg = p.brand })
hi('Operator', { fg = p.charcoal })
hi('Keyword', { fg = p.dark_warm, bold = true })
...
hi('Type', { fg = p.brand })
hi('StorageClass', { fg = p.dark_warm, bold = true })
...
hi('DiffAdd', { fg = p.green, bg = '#edf0e6' })
hi('DiffChange', { fg = p.amber, bg = '#f1eadc' })
hi('DiffDelete', { fg = p.error, bg = '#f1e3df' })
hi('DiffText', { fg = p.near_black, bg = '#e7d9bd' })
hi('Added', { fg = p.green })
...
hi('DiagnosticVirtualTextError', { fg = p.error, bg = '#f1e3df' })
hi('DiagnosticVirtualTextWarn', { fg = p.amber, bg = '#f1eadc' })
hi('DiagnosticVirtualTextInfo', { fg = p.brand_light, bg = p.tag })
hi('DiagnosticVirtualTextHint', { fg = p.olive, bg = p.ivory })

hi('@variable', { fg = p.near_black })
hi('@variable.builtin', { fg = p.dark_warm })
hi('@constant', { fg = p.brand })
...
hi('@keyword', { fg = p.dark_warm, bold = true })
hi('@keyword.function', { fg = p.dark_warm, bold = true })
hi('@keyword.return', { fg = p.dark_warm, bold = true })
hi('@operator', { fg = p.charcoal })
hi('@type', { fg = p.brand })
...
hi('SnacksPicker', { fg = p.charcoal, bg = bg_float })
hi('SnacksPickerBorder', { fg = p.border_warm, bg = bg_float })
hi('SnacksPickerMatch', { fg = p.brand, bold = true })
hi('SnacksPickerDir', { fg = p.olive })
hi('SnacksPickerPathHidden', { fg = p.stone })
hi('SnacksPickerPathIgnored', { fg = p.stone })
