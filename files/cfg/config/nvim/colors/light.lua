...
local red = '#c4331d'
local grey = '#5e5e5e'
local light_grey = '#efefef'
local comment_grey = '#d8d8d8'
local selection_grey = '#d0d0d0'
local border = '#cccccc'
...
local highlights = {
  ...
  Identifier = { fg = black },
  Function = { fg = black },
  IncSearch = { fg = black, bg = yellow, bold = true },
  CurSearch = { fg = black, bg = yellow, bold = true },
  ...
  PmenuSel = { fg = black, bg = selection_grey, bold = true },
  ...
  NeoTreeIgnored = { fg = grey },
  NeoTreeGitAdded = { fg = green, bold = true },
  NeoTreeGitModified = { fg = dark_yellow, bold = true },
  ...
  NeoTreeGitUnstaged = { fg = dark_yellow, bold = true },
  ...
  -- Rust
  rustCommentBlock = { fg = black, bg = comment_grey, bold = true },
  rustCommentBlockDoc = { fg = black, bg = comment_grey, bold = true },
  rustCommentLine = { fg = black, bg = comment_grey, bold = true },
  rustCommentLineDoc = { fg = black, bg = comment_grey, bold = true },
  ...
  PounceGap = { link = 'None' },
  -- Python
  pythonComment = { fg = black, bg = comment_grey, bold = true },
  ...
  -- Treesitter
  ['@comment'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.documentation'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.error'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.hint'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.info'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.line'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.note'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.todo'] = { fg = black, bg = comment_grey, bold = true },
  ['@comment.warning'] = { fg = black, bg = comment_grey, bold = true },
  ['@markup.link'] = { fg = blue },
