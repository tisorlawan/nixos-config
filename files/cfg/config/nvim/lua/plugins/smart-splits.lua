return {
  ...
  keys = {
    ...
    { '<leader>oh', function() require('smart-splits').swap_buf_left() end, desc = 'Swap left', silent = true },
    { '<leader>oj', function() require('smart-splits').swap_buf_down() end, desc = 'Swap down', silent = true },
    { '<leader>ok', function() require('smart-splits').swap_buf_up() end, desc = 'Swap up', silent = true },
    { '<leader>ol', function() require('smart-splits').swap_buf_right() end, desc = 'Swap right', silent = true },
  },
  config = function()
