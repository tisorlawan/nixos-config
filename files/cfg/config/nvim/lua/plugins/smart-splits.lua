return {
  {
    ...
    keys = {
      ...
      { "<leader><leader>h", function() require("smart-splits").swap_buf_left() end, { silent = true } },
      { "<leader><leader>j", function() require("smart-splits").swap_buf_down() end, { silent = true } },
      { "<leader><leader>k", function() require("smart-splits").swap_buf_up() end, { silent = true } },
      { "<leader><leader>l", function() require("smart-splits").swap_buf_right() end, { silent = true } },
    },
    config = function()
